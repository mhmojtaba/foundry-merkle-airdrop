...
contract GenerateInput is Script {
    ...
    string[] types = new string[](2); // array of the value types in the tree (account and amount)
    uint256 count; // the number of addresses that are going to be claimed
    string[] whitelist = new string[](4); // the list of addresses that are be able to claim -> for example 4 addresses in the current list (account
    string private constant  INPUT_PATH = "/script/target/input.json"; // the path to the input json file
